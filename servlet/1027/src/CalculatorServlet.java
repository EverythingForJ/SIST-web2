...
public class CalculatorServlet extends HttpServlet {
    ...
    throws ServletException, IOException{
		req.setCharacterEncoding("utf-8"); // Post 형식의 한글 출력 방법
	...
	private String calc(HttpServletRequest req) {
		...
		String today = String.format("귀하가 방문한 날짜는 %1$tY년 %1$tm월 %1$td일입니다.", new Date());
		...
		String str= "<span style='color:blue'>"+name+"</span>님!<br />"+ 
					today + "<br />" + array.length+"문제 중 "+ (array.length-count)
					+ "개를 틀려서 "+ "<span style='color:red'>"+(count*20)+"점</span>입니다. ";
